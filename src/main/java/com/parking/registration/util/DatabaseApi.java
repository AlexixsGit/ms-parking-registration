...
public class DatabaseApi {
	...
	public Database getCloudantConnection() {
		CloudantClient cloudantClient = ClientBuilder.account(this.yamlProperties.account)
				.username(this.yamlProperties.username).password(this.yamlProperties.password).build();
